...
#instead of looping through the list, loop through the dicts keys and then the values
...
for u in dicts:
    currentX = dicts[u]
    binValue = (currentX - abs(smallest))/divided
    dicts[u] = binValue
